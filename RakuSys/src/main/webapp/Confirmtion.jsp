...
<body id="confirm">
	...
	<div id="container">
		...
		<div id="language" align="right">日本語</div>
			...
			<div id="completeArea">
				<div class="question">
					...
					<p style="color: #bf0000;">
						「<em class="em">登録する</em>」ボタンを押すと登録が完了します。
					</p>
				</div>
			</div>
			...
			<table class="confirm" cellspacing="0" summary="memberInformation1">
				...
				<tbody>
					...
					<tr>
						...
						<td><br> <%
 String radio_mail = (String) request.getAttribute("radio_mail");
 %> <%=radio_mail%> （メールアドレスをユーザIDとして使用します）</td>
					</tr>
 ...
 %> <%=fname%>
					...
					<tr>
						...
						<td>
							<%
							String lname_kana = (String) request.getAttribute("lname_kana");
							%> <%=lname_kana%> <%
 String fname_kana = (String) request.getAttribute("fname_kana");
 %> <%=fname_kana%>
			...
			<br> <br>
				...
				<div style="border: 1px solid #000000; padding: 5px; margin: 5px;">
					...
					<table width="700" border="0" cellspacing="0" cellpadding="0"
						...
						<tbody>
							<tr>
								<td>
									<table width="825px" cellspacing="0" cellpadding="0"
																...
																<td style="border-collapse: collapse; padding: 6px;">
																	<table width="100%" cellspacing="0" cellpadding="0"
																		...
																		<tbody>
																				...
																				<td colspan="2">
																					<table valign="top">
																						<tbody>
																							<tr>
																								<td><img
																									src="https://image.rakuten.co.jp/com/img/thumb/member/img/icn_mail.gif"
																									width="24" height="17" alt=""
																									style="padding-right: 3px; border: 0"></td>
																								<td style="font-size: 14px;"><b>楽天会員ニュース（週1回～2回配信）</b>
																								</td>
																							</tr>
																						</tbody>
																					</table>
																			...
																			<tr>
																				<td colspan="2"
																					style="font-size: 13px; padding: 3px 0;">
																					...
																					style="color: #bf0000; font-weight: bold;">「購読する」のチェックを外してください</span>。
																				</td>
																			</tr>
																		</tbody>
																	</table>
									...
									<table valign="middle"
										...
										<tbody>
											<tr>
												<td><input type="checkbox" name="chk_news" value="true"
													checked=""></td>
												<td><b>&nbsp;購読する</b></td>
											</tr>
										</tbody>
				...
				<input type="hidden" name="tok"
					value="WE14kVCcjvxaTk4vJJXHwkclNKEoQ0JQtoFuSuonlV7HXLidZk+5GJ9F8tnzrP9A">

				<input type="hidden" name="pp_version" value="20220331"> <input
					type="hidden" name="device_fp"
