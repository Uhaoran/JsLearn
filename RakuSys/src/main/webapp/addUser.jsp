...
<head>
<meta charset="UTF-8">
<link rel="stylesheet" type="text/css" href="css/runobb.css">
</head>
...
<body id="confirm">
	...
	<div id="container">
      ...
      //-->
		...
		<div id="contents">
			...
			<form name="Regist1Form" method="post" action="./addUser"
				autocomplete="off">
					...
					<tbody>
						<tr>
							...
							<td><em>&lt;半角英数字&gt;</em><br> <em>他の会員が登録済みのメールアドレスは登録できません。</em><br>
								<input type="text" name="email" maxlength="100" size="35"
								value="" onchange="email2.value='';" class="text email" title=""
								style="color: rgb(153, 153, 153);"> <br> <br>
								<em class="em"><em class="em">確認のためもう一度入力してください（コピー・貼り付けはしないでください。）</em></em><br>
								<input type="text" name="email2" maxlength="100" size="35"
								value="" class="text email2" title=""
								style="color: rgb(153, 153, 153);"> <br> <br>
							</td>
							<td class="note help"><a class="help"
						...
						<tr>
							...
							<td nowrap=""><em>会員向けサービスにログインするときに使用します。</em><br> <input
								type="radio" name="radio_mail" value="0" checked="checked"
								onclick="changeName('email')">メールアドレスをユーザIDとして使用<br>
								<br> <input type="radio" name="radio_mail" value="1"
								onclick="changeName('u')">メールアドレス以外をユーザIDとして使用<br> <script>
                                 function changeName(name) {
                                              document.getElementById("name").setAttribute("name", name);
                                                                                                                            }
</script> <em>&lt;6文字以上・半角英数字&gt; 数字だけにすることはできません</em><br>
								<div id="user">
									<input type="text" name="u" maxlength="100" size="50" value=""
										class="text userid" title="(例) rakuten1234"
										style="color: rgb(153, 153, 153);">
								</div></td>
							<td class="note"><a class="help"
						...
						<tr>
							...
							<td><em>&lt;6文字以上半角英数字&gt;</em><br> <em>「ユーザID」と同じものは登録できません</em><br>
								<em>第三者によるログインを防ぐために、できるだけ複雑なものを設定してください。</em><br> <input
								type="password" name="p" maxlength="128" size="20" value=""
								onkeypress="pFlagOn()" onfocus="pFocus(this)" id="p_id"
								title="(例) 18f5ns1kzm"><br>
					...
					<tbody>
						<tr>
							...
							<td><em>入力情報に誤りがあると、パスワード再設定が正しく行えない場合があります。</em><br> <strong><em
									class="em">ご自身の氏名をお間違えないように登録してください。</em></strong><br> （姓） <input
								type="text" id="lname" name="lname" alt="" class="text name">
								（名） <input type="text" id="fname" name="fname" alt=""
								class="text name"> <br></td>
							<td class="note">&nbsp;</td>
						</tr>
						...
						<tr>
							...
							<td><em>&lt;全角カタカナのみ&gt;</em><br> （姓） <input
								type="text" id="lname_kana" name="lname_kana" alt=""
								class="text name"> （名） <input type="text"
								id="fname_kana" name="fname_kana" alt="" class="text name">
								<br></td>
							<td class="note">&nbsp;</td>
						</tr>
							...
							<td>
								<div id="challenger">
									<input name="cres" id="cres" type="hidden"
										value="08jBdT910kRcAMRb">
								</div> <input type="hidden" name="cid" id="cid"
								...
								value="db74b602-4b9b-4713-9d2f-d6c2972fe75c"> <input
								type="hidden" name="ctid" id="ctid"
								value="63b4f2a0-4ff5-4a56-98ff-99e1a7d7098c"> <script
									id="challenger-script" type="text/javascript">window.__challenger_conf || (window.__challenger_conf = {}),
				...
				<input type="hidden" name="tok"
					value="HCJoWRtWKWQecEVUbtZicEx6vxpdC2OB0wfIKuD8+Y+kOOj19IXZjmERgRfnuOAC">
	...
	<script type="text/javascript"
		src="//image.rakuten.co.jp/com/js/omniture/s_code.js"></script>
	<img src="https://image.rakuten.co.jp/com/img/home/t.gif"
		name="s_i_rakutendev" style="position: absolute" width="1" height="1">
	<script type="text/javascript"
		src="//www.rakuten.co.jp/com/js/omniture/codetopaste/login/sc_login.js"></script>
	<!-- End SiteCatalyst tags -->
	...
	<!-- End of RAT tags -->
	<script type="text/javascript"
		src="https://static.id.rakuten.co.jp/static/com/js/id/no_banchi.js"></script>
